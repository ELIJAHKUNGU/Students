        ...
        <nav id="sidebarMenu" class="col-md-4 col-lg-2 d-md-block bg-light sidebar collapse">
            ...
            <div class="col-sm-8">
                ...
                <div class=" shadow mt-5 p-5">
                    <h3>OFFER / REJECT BURSARY APPLICATION</h3>
                    ...
                    <div class="pl-5">
                            ...
                            if (isset($_POST["save"]))
                            {
                                ...
                                $id = $row["b_id"];
                                require 'db.php';
                                $sql ="UPDATE `bursaries` SET `status`='$status' WHERE  b_id='$id'";
                        ...
                        <form class="form" method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="b_id" disabled value="<?php echo $row['b_id'] ?>">
                            </div>
                            ...
                            <select name="status" id="" class="form-control mt-3" required>
                                ...
                                <option value="2">Unsuccessfully</option>
