    ...
    <div class="row">
        ...
        require 'security.php';
            ...
            if (isset($_POST["save"])) {
                ...
                $e_salarys = $row['e_salary'] - $row['e_loans'];
                
               
                $sql = "INSERT INTO `payslips`(`pay_id`, `e_name`, `e_phone`, `e_idno`, `e_email`, `e_salary`) 
                VALUES ('null','$e_name','$e_phone','$e_idno','$e_email','$e_salarys')";
                ...
                <div class="card pl-4 pr-4 mt-5">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="e_loansd"  value="<?=$e_loans?>" disabled class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="">Salary</label>
                            <input type="text" name="e_salaryd" value="<?=$e_salary?>" disabled class="form-control">
                        </div>
                    <button type="submit" name="save" class="btn btn-success text-white">PAY</button>
                    </form>
                </div>
            </div>
        </div>